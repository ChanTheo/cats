...
// // synchronous function to fetch a cat breed
// const breedDetails = function(breed, functiontToRunWhenThingsAreDone) {
//   console.log('breedDetailsFromFile: Calling readFile...');
//   fs.readFile(`./data/${breed}.txt`, 'utf8', (error, data) => {
//     console.log("In readFile's Callback: it has the data.");

//     if(!error) {
//     functiontToRunWhenThingsAreDone(data);
...
// // get the return value right away from the function
// const bombay = breedDetails('Bombay', printOutCatBreed);
// // console.log(bombay); //=> prints out the description for that breed
